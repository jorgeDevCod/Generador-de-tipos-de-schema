...
export const schemaFields = {
  ...
  Course: {
    ...
    fields: {
      name: { label: "Nombre del curso", type: "text" },
      description: { label: "Descripción", type: "textarea" },
      provider: {
        label: "Proveedor",
        type: "object",
        fields: {
          name: { label: "Nombre de la organización", type: "text" },
        },
      },
      educationalUse: { label: "Uso educativo", type: "text" },
      offers: {
        label: "Oferta",
        type: "object",
        fields: {
          price: { label: "Precio", type: "number" },
          priceCurrency: { label: "Moneda", type: "text" },
          availability: { label: "URL de disponibilidad", type: "text" },
          category: { label: "Categoría de la oferta", type: "text" },
        },
      },
      courseCode: { label: "Código del curso", type: "text" },
      url: { label: "URL", type: "text" },
      category: { label: "Categoría general", type: "text" },
      hasCourseInstance: {
        label: "Instancias del curso",
        type: "array",
        fields: {
          name: { label: "Nombre de la instancia", type: "text" },
          startDate: { label: "Fecha de inicio", type: "date" },
          endDate: { label: "Fecha de fin", type: "date" },
          location: {
            label: "Ubicación",
            type: "object",
            fields: {
              name: { label: "Nombre del lugar", type: "text" },
            },
          },
          courseMode: { label: "Modo del curso", type: "text" },
          courseWorkLoad: { label: "Carga de trabajo", type: "text" },
        },
      },
    },
  },
  ...
  FAQPage: {
    ...
    fields: {
      mainEntity: {
        ...
        placeholder:
          '[{"name": "Pregunta 1", "acceptedAnswer": {"text": "Respuesta 1"}}]',
      },
    },
  },
  ...
  BreadcrumbList: {
    ...
    fields: {
      itemListElement: {
        ...
        placeholder:
          '[{"position": 1, "name": "Inicio", "item": "https://ejemplo.com"}]',
      },
    },
  },
  ...
  HowTo: {
    ...
    fields: {
      ...
      totalTime: {
        type: "text",
        label: "Tiempo total (formato ISO, ej: PT2H30M)",
      },
      estimatedCost: { type: "number", label: "Costo estimado" },
      currency: { type: "text", label: "Moneda del costo" },
      supply: {
        type: "textarea",
        label: "Materiales necesarios (uno por línea)",
      },
      tool: {
        type: "textarea",
        label: "Herramientas necesarias (una por línea)",
      },
      step: {
        type: "textarea",
  ...
  LocalBusiness: {
    ...
    fields: {
      ...
      openingHours: {
        type: "text",
        label: "Horario de apertura (ej: Mo-Fr 09:00-17:00)",
      },
